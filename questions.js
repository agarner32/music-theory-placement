...
const questions = [
...

  {
    ...
    choices: [
      { label: "4/4; barline after the first half note",     correct: true,  feedback: "Correct! Each measure has 4 beats: quarter + quarter + half in measure one, quarter rest + quarter + dotted quarter + eighth in measure two." },
